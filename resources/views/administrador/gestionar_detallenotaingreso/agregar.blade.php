                    ...
                    <div class="d-table-cell align-middle">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="m-sm-4">
                                    <!--route de form -->
                                    <form action="{{ url('administrador/detallenotaingreso/' . $dato->id) }}" method="POST"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control form-control-lg" type="decimal" name="costo"
                                                value="{{ $dato->precioStock }}" placeholder="00.00" />
                                            @error('costo')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control form-control-lg" type="text" name="categoria"
                                                value="{{ $dato->idcategoria }}" placeholder="" />
                                            @error('categoria')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control form-control-lg" type="text" name="marca"
                                                value="{{ $dato->idmarca }}" placeholder="" />
                                            @error('marca')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="text-center mt-3">
                                            ...
                                            <a href="{{ url('administrador/detallenotaingreso/producto') }}"
